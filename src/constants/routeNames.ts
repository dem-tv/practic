...
export const ROUTE_NAME_USS = 'ROUTE_LABOR_USS';
export const ROUTE_NAME_MANAGEMENT_EMPLOYEES = 'ROUTE_NAME_MANAGEMENT_EMPLOYEES';
...
export const ROUTE_NAME_LABOR_COSTS_UNDERVALUED_ISSUES =
...
export const ROUTE_NAME_APPLICATIONS_PERFORMANCE_EVALUATION =
...
export const ROUTE_NAME_EXTRA_TASKS_BY_DATE =
  'ROUTE_NAME_ANAROUTE_NAME_EXTRA_TASKS_BY_DATELYSIS_TASK_STATUS_CHANGES';
export const ROUTE_NAME_ANALYSIS_TASKS = 'ROUTE_NAME_ANALYSIS_TASKS';
export const ROUTE_NAME_TASKS_RETURNED_AND_RECEIVED_FOR_ONE_PERIOD =
  'ROUTE_NAME_TASKS_RETURNED_AND_RECEIVED_FOR_ONE_PERIOD';
export const ROUTE_NAME_ANALYSIS_TASK_STATUS_CHANGESTASKS_RETURNED_AND_RECEIVED_AS_UNFULFILLED_FOR_ONE_PERIOD =
  'ROUTE_NAME_ANALYSIS_TASK_STATUS_CHANGESTASKS_RETURNED_AND_RECEIVED_AS_UNFULFILLED_FOR_ONE_PERIOD';
export const ROUTE_NAME_TASKS_RETURNED_FOR_REVISION_BY_PERIOD =
  'ROUTE_NAME_TASKS_RETURNED_FOR_REVISION_BY_PERIOD';
export const ROUTE_NAME_TASKS_EXTRA_PERIOD = 'ROUTE_NAME_TASKS_EXTRA_PERIOD';
export const ROUTE_NAME_DEADLINE_CONTROL_SUPPORT_TASKS_EXECUTION =
...
export const ROUTE_NAME_UNFULFILLED_REQUESTS_ON_APPRECIATED_AND_UNAPPRECIATED =
...
export const ROUTE_NAME_RECEIVED_TASKS_BY_PERIOD =
  'ROUTE_NAROUTE_NAME_RECEIVED_TASKS_BY_PERIODME_ACT_OF_SUPPORT_BIB';
